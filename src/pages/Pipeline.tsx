      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Track opportunities and confirmed sales orders
          </p>
        </div>
        ...
        <Tabs defaultValue="opportunities" className="w-full">
          <TabsList>
            <TabsTrigger value="opportunities">Pipeline Opportunities</TabsTrigger>
            <TabsTrigger value="sales-orders">Confirmed Orders</TabsTrigger>
          </TabsList>
